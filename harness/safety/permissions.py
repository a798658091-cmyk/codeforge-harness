...
DEFAULT_PERMISSION_RULES = {
    ...
    "subagent_status": PermissionDecision.ALLOW,
    "subagent_list": PermissionDecision.ALLOW,
    "subagent_diff": PermissionDecision.ALLOW,
    "message_bus_events": PermissionDecision.ALLOW,
